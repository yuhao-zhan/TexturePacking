...
# Generate a color for each item before packing starts
item_colors = {i: np.random.rand(3, ) for i in range(itemNum)}  # Random color for each item
...
# print the max ran and min ran
print(f"Max Coverage Ratio Ran: {max_ran}\t Min Coverage Ratio Ran: {min_ran}")
# Visualize the packing for max and min coverage ratio
